    ...
    <div class="container">
        ...
        <section class="task-card">
            <div class="task-header">
                ...
                <span class="task-title">Логические выражения</span>
    ...
    if len(set(t)) == 3:
        ...
        <section class="task-card">
            <div class="task-header">
                ...
                <span class="task-title">Системы счисления</span>
                <span class="task-badge">✏️ Python 3</span>
            </div>
            <div class="code-wrapper">
                <button class="copy-btn" onclick="copyCode(this)">📋 Копировать</button>
                <pre><code class="language-python"># region 1
def n3(num):
    if num == 0:
        return '0'
    res = ''
...
print(max(mand))</code></pre>
        ...
        <section class="task-card">
            <div class="task-header">
                ...
                <span class="task-title">Комбинаторика (itertools)</span>
                <span class="task-badge">✏️ Python 3</span>
            </div>
            <div class="code-wrapper">
                <button class="copy-btn" onclick="copyCode(this)">📋 Копировать</button>
...
for a in range(1000, 1, -1):
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            hljs.configure({
                tabReplace: '    '  // 4 пробела для табуляции
            });
            hljs.highlightAll();
        });
